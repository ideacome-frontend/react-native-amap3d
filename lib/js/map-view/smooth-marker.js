...
var SmoothMoveMarker = /** @class */ (function (_super) {
    ...
    SmoothMoveMarker.prototype.fitMapBounds = function () {
    ...
    SmoothMoveMarker.prototype.render = function () {
        var props = __assign(__assign(__assign({}, this.props), { mapBounds: this.props.bounds || [] }), this.handlers(events));
        if (this.props.offsetBottom && react_native_1.Platform.OS === 'android') {
            props.offsetBottom = react_native_1.PixelRatio.getPixelSizeForLayoutSize(this.props.offsetBottom) + 50;
        }
